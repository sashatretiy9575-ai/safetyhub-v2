...
function mapBatch(raw: unknown): DocumentBatch {
  ...
  return { id: b.id, organization: b.organization, courseSlug: b.course_slug, date: b.document_date, number: b.protocol_number, automatic: b.automatic, version: b.version };
}
