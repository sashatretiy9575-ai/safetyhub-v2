...
test('profile signatures follow explicit signer identities and mixed snapshots remain separate protocols', () => {
...
test('education follows new form applicability and first-aid historical layout remains stable', async () => {
  ...
  assert.equal(groupItemsForProtocols([{ organization:'A', titleSnapshot:'T', branding:base }, { organization:'A', titleSnapshot:'T', branding:{...base,protocolLayoutVersion:2} }]).length, 2);
});
