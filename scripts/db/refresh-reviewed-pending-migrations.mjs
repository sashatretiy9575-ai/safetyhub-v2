...
//
// Usage: node scripts/db/refresh-reviewed-pending-migrations.mjs <firstPendingVersion>
...
const GATE = path.resolve('scripts', 'db', 'check-linked-release-migrations.mjs');
