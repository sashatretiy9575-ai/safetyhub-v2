...
import { formatLegalDate, PRIVACY_POLICY_V1_1, type LegalDocumentVersion } from '@/lib/legal';

type TermsPolicyV21Props = {
...
/**
 * Rendered copy for terms-2.1, the only pre-structured Russian terms copy.
 * It is immutable: changing its wording requires another legal-document version.
 */
export function TermsPolicyV21({ policy }: TermsPolicyV21Props) {
