...
/**
 * Rendered copy for privacy-1.1, the only pre-structured Russian privacy copy.
 * It is immutable: changing its wording requires another legal-document version.
 */
export function PrivacyPolicyV11({ policy }: PrivacyPolicyV11Props) {
