  ...
  return (
    <div className={cn('inline-flex items-center gap-2', className)}>
      <div
        data-logo-mark
        className={cn(
          'grid size-7 shrink-0 place-items-center rounded-[10px] border shadow-[var(--shadow-soft)] lg:size-8 lg:rounded-[var(--radius-control)]',
          inverse
      ...
      <span
        data-logo-wordmark
        className={cn(
          'text-body-sm xs:text-lg font-extrabold tracking-tight',
