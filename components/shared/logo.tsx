  ...
  return (
    <div className={cn('inline-flex items-center gap-2', className)}>
      <div
        data-logo-mark
        className={cn(
          'grid size-7 shrink-0 place-items-center rounded-[10px] border shadow-[var(--shadow-soft)] min-[1024px]:size-8 min-[1024px]:rounded-[var(--radius-control)]',
          inverse
      ...
      >
        <ShieldCheck size={19} weight="regular" className="min-[1024px]:size-5" />
      </div>
      <span
        data-logo-wordmark
        className={cn(
