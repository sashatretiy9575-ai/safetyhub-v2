...
- Keep assessment answer keys out of `public/`, browser bundles, public RPC responses, logs, and analytics. The repository is currently private; re-check repository visibility before committing answer-key snapshots.
